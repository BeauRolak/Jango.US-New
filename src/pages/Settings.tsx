      ...
      <div className={"settings-grid"}>
        ...
        <section className={"settings-panel"}>
          ...
          {tab === "Gameplay" && (<>
            ...
            <Card title={"Onboarding"}><p className={"muted"}>Replay the new-player walkthrough of the arena, Scalps, matches, tournaments and rewards.</p><button className={"set-btn"} onClick={() => window.dispatchEvent(new Event("jango:open-onboarding"))}>Replay Walkthrough</button></Card>
